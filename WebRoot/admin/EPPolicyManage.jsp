...
<html>
  ...
  <div style="height: 20px"></div>
    <div class="List_title"><img src="admin/images/g.png" width="17px" height="15px"/> 环保政策法规管理</div>
  	<div class="List_column">
  		<button class="List_button" onclick="addWindow('增加环保政策法规','admin/addEPPolicy.jsp',900,480)">增加</button>
  		<button class="List_button" onclick="manage('policy/epPolAct!EPPolicy_index.action','verify','')">已审核</button>
  		<button class="List_button" onclick="manage('policy/epPolAct!EPPolicy_index.action','notVerify','')">未审核</button>
...
<s:iterator value="entity" id="entity">
			<tr>
					...
					<td align="center">[<a href="policy/epPolAct!detail.action?id=${entity.id }" class="opLink" target="_blank">查看</a>][<a href="javascript:verify('policy/epPolAct!setVerify.action?id=${entity.id }','policy/epPolAct!EPPolicy_index.action')" class="opLink">审核</a>][<a href="javascript:changeWindow('修改环保新闻','policy/epPolAct!update.action?id=${entity.id }',900,590)" class="opLink" >修改</a>][<a href="javascript:manage('policy/epPolAct!EPPolicy','delete','${entity.id}')" class="opLink">删除</a>]</td>
			</tr>
			</s:iterator>
		</table>
		<table class="List_table_page">
			<tr><td>共&nbsp;<s:property value="pager.maxPages" />&nbsp;页&nbsp;每页&nbsp;<s:property value="pager.getPageSize()" />&nbsp;条&nbsp;页次：<s:property
											...
											<td width="30px"></td>
											<td><a
												href="<s:url value="policy/epPolAct!EPPolicy_page.action"><s:param name="method" value="%{'first'}"/><s:param name="pager.currentPage" value="pager.currentPage"/></s:url>">
											<span style="background:#DCD9D4;">首页</span></a>
											</td>
											<td><a
												href="<s:url value="policy/epPolAct!EPPolicy_page.action"><s:param name="method" value="%{'back'}"/><s:param name="pager.currentPage" value="pager.currentPage"/></s:url>">
												<span style="background:#DCD9D4;">上一页</span></a>
											</td>
											<td><span style="background:#EBEBEA;">&nbsp;<s:property
													value="pager.currentPage" />&nbsp;</span></td>
											<td><a
												href="<s:url value="policy/epPolAct!EPPolicy_page.action"><s:param name="method" value="%{'next'}"/><s:param name="pager.currentPage" value="pager.currentPage"/></s:url>">
												<span style="background:#DCD9D4;">下一页</span></a>
											</td>
											<td align="left">
													
											<form action="policy/epPolAct!EPPolicy_page.action" method="post" id="gotoform"  style="margin-bottom: 0">
											...
											<td width="0px"></td>
											<td><a
												href="<s:url value="policy/epPolAct!EPPolicy_page.action"><s:param name="method" value="%{'last'}"/><s:param name="pager.currentPage" value="pager.currentPage"/></s:url>">
												<span style="background:#DCD9D4;">尾页</span></a>
											</td></tr>
</table>
	</div>
	<div class="List_column" ><div style="margin-top: 12px;font-size: 14px;">选择：<a href="javascript:checkbox('all')">全部</a> - <a href="javascript:checkbox('inverse')">反选</a> - <a href="javascript:manage('policy/epPolAct!EPPolicy','deleteChecked','')">所选删除</a></div></div>
  </body>
</html>
