		...
		<span class="List_search" style="margin-left:399px;">
			<form action="message/mesAct!searchMessage.action" method="post"
				...
				<span style="font-size:14px;">选择浏览栏目：</span><select name="type"
					...
					<option value="政策解答" <%if (type.equals("政策解答")) {%>
						selected="selected" <%}%>>政策解答</option>
					<option value="技术支持" <%if (type.equals("技术支持")) {%>
						selected="selected" <%}%>>技术支持</option>
					<option value="主题活动" <%if (type.equals("主题活动")) {%>
						selected="selected" <%}%>>主题活动</option>
					<option value="" <%if (type.equals("全部")) {%> selected="selected"
						<%}%>>全部</option>
	...
	<div class="List_info">
		...
		<table class="List_table_page">
			<tr>
				...
				<td width="30px"></td>
				<td><a
					href="<s:url value="message/mesAct!searchMessage.action"><s:param name="method" value="%{'first'}"/><s:param name="pager.currentPage" value="pager.currentPage"/><s:param name="type" value="type"/></s:url>">
						<span style="background:#DCD9D4;">首页</span>
				</a></td>
				<td><a
					href="<s:url value="message/mesAct!searchMessage.action"><s:param name="method" value="%{'back'}"/><s:param name="pager.currentPage" value="pager.currentPage"/><s:param name="type" value="type"/></s:url>">
				...
				<td><a
					href="<s:url value="message/mesAct!searchMessage.action"><s:param name="method" value="%{'next'}"/><s:param name="pager.currentPage" value="pager.currentPage"/><s:param name="type" value="type"/></s:url>">
						<span style="background:#DCD9D4;">下一页</span>
				</a></td>
				<td align="left">

					<form action="message/mesAct!searchMessage.action" method="post" id="gotoform" 
				...
				<td width="0px"></td>
				<td><a
					href="<s:url value="message/mesAct!searchMessage.action"><s:param name="method" value="%{'last'}"/><s:param name="pager.currentPage" value="pager.currentPage"/><s:param name="type" value="type"/></s:url>">
