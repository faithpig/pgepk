...
<html>
  ...
  <div style="height: 20px"></div>
    <div class="List_title"><img src="admin/images/g.png" width="17px" height="15px"/> 环保新闻管理</div>
  	<div class="List_column">
  		<button class="List_button" onclick="addWindow('增加环保新闻','admin/addEPNews.jsp',900,480)">增加</button>
  		<button class="List_button" onclick="manage('news/epNewAct!EPNews_index.action','verify','')">已审核</button>
  		<button class="List_button" onclick="manage('news/epNewAct!EPNews_index.action','notVerify','')">未审核</button>
		<span class="List_search"style="margin-left:425px;">
			<form action="news/epNewAct!searchEPNews.action" method="post"
	...
	<div class="List_info">
		<table class="List_table">
			...
			<tr>
					...
					<td align="center">[<a href="news/epNewAct!detail.action?id=${entity.id }" class="opLink" target="_blank">查看</a>][<a href="javascript:verify('news/epNewAct!setVerify.action?id=${entity.id }','news/epNewAct!EPNews_index.action')" class="opLink">审核</a>][<a href="javascript:changeWindow('修改环保新闻','news/epNewAct!update.action?id=${entity.id }',900,590)" class="opLink" >修改</a>][<a href="javascript:manage('news/epNewAct!EPNews','delete',${entity.id})" class="opLink">删除</a>]</td>
			</tr>
			</s:iterator>
		</table>
		<table class="List_table_page">
			<tr><td>共&nbsp;<s:property value="pager.maxPages" />&nbsp;页&nbsp;每页&nbsp;<s:property value="pager.getPageSize()" />&nbsp;条&nbsp;页次：<s:property
											...
											<td width="30px"></td>
											<td><a
												href="<s:url value="news/epNewAct!searchEPNews.action"><s:param name="method" value="%{'first'}"/><s:param name="pager.currentPage" value="pager.currentPage"/><s:param name="key" value="key"/><s:param name="type" value="type"/></s:url>">
											<span style="background:#DCD9D4;">首页</span></a>
											</td>
											<td><a
												href="<s:url value="news/epNewAct!searchEPNews.action"><s:param name="method" value="%{'back'}"/><s:param name="pager.currentPage" value="pager.currentPage"/><s:param name="key" value="key"/><s:param name="type" value="type"/></s:url>">
												<span style="background:#DCD9D4;">上一页</span></a>
											</td>
											<td><span style="background:#EBEBEA;">&nbsp;<s:property
													value="pager.currentPage" />&nbsp;</span></td>
											<td><a
												href="<s:url value="news/epNewAct!searchEPNews.action"><s:param name="method" value="%{'next'}"/><s:param name="pager.currentPage" value="pager.currentPage"/><s:param name="key" value="key"/><s:param name="type" value="type"/></s:url>">
												<span style="background:#DCD9D4;">下一页</span></a>
											</td>
											<td align="left">
													
											<form action="news/epNewAct!searchEPNews.action" method="post" id="gotoform"  style="margin-bottom: 0">
											...
											<td width="0px"></td>
											<td><a
												href="<s:url value="news/epNewAct!searchEPNews.action"><s:param name="method" value="%{'last'}"/><s:param name="pager.currentPage" value="pager.currentPage"/><s:param name="key" value="key"/><s:param name="type" value="type"/></s:url>">
												<span style="background:#DCD9D4;">尾页</span></a>
											</td></tr>
</table>
	</div>
	<div class="List_column" ><div style="margin-top: 12px;font-size: 14px;">选择：<a href="javascript:checkbox('all')">全部</a> - <a href="javascript:checkbox('inverse')">反选</a> - <a href="javascript:manage('news/epNewAct!EPNews','deleteChecked','')">所选删除</a></div></div>
  </body>
</html>
