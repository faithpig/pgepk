  ...
  <body>
    ...
    <div class="List_title"><img src="admin/images/g.png" width="17px" height="15px"/> 管理员管理</div>
  	<div class="List_column">
		...
		<span class="List_search" style="margin-left:595px;">
			<form action="admin/admAct!searchAdmin.action" method="post" target="_parent"
				style="margin-bottom:0px;margin-top: 0px;padding:0 0; "onsubmit="return check(this)" >
				<input type="text" name="key" id="key" class="List_search_input" /><select
	...
	<div class="List_info">
		<table class="List_table">
			...
			<tr>
					...
					<td align="center">[<a href="javascript:addWindow('修改管理员信息', 'admin/admAct!changeAdmin.action?id=${entity.id}', 300, 190)" class="opLink">修改</a>][<a href="javascript:manage('admin/admAct!AdminManage','delete',${entity.id})" class="opLink">删除</a>]</td>
			</tr>
			</s:iterator>
		</table>
		<table class="List_table_page">
			<tr><td>共&nbsp;<s:property value="pager.maxPages" />&nbsp;页&nbsp;每页&nbsp;<s:property value="pager.getPageSize()" />&nbsp;条&nbsp;页次：<s:property
											...
											<td width="30px"></td>
											<td><a
												href="<s:url value="admin/admAct!AdminManage_page.action"><s:param name="method" value="%{'first'}"/><s:param name="pager.currentPage" value="pager.currentPage"/></s:url>">
											<span style="background:#DCD9D4;">首页</span></a>
											</td>
											<td><a
												href="<s:url value="admin/admAct!AdminManage_page.action"><s:param name="method" value="%{'back'}"/><s:param name="pager.currentPage" value="pager.currentPage"/></s:url>">
												<span style="background:#DCD9D4;">上一页</span></a>
											</td>
											<td><span style="background:#EBEBEA;">&nbsp;<s:property
													value="pager.currentPage" />&nbsp;</span></td>
											<td><a
												href="<s:url value="admin/admAct!AdminManage_page.action"><s:param name="method" value="%{'next'}"/><s:param name="pager.currentPage" value="pager.currentPage"/></s:url>">
												<span style="background:#DCD9D4;">下一页</span></a>
											</td>
											<td align="left">
													
											<form action="admin/admAct!AdminManage_page.action" method="post" id="gotoform"  style="margin-bottom: 0">
												<s:hidden name="method" value="%{'jump'}" />
												<input type="text" name="pager.currentPage" style="width:20px;height:13px;font-size: 12px;padding:0 0 0 0;" value="" id="gotopage" />
											...
											<td width="0px"></td>
											<td><a
												href="<s:url value="admin/admAct!AdminManage_page.action"><s:param name="method" value="%{'last'}"/><s:param name="pager.currentPage" value="pager.currentPage"/></s:url>">
