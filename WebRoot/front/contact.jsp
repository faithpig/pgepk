...
<body>
	<div class="allbody">
        <div class="headertop">
            ...
            <div class="fr logo_y"><a class="sy" href="#" onclick="return set_homepage(this,'http://www.pgepk.com/');">设为首页</a><a class="sc" href="http://www.pgepk.com" onclick="return add_favorite(this,'电网环保知识科普');">加入收藏</a><a class="lx" href="<%=basePath%>contact/conAct!detail.action">联系我们</a><a class="dt" href="<%=basePath%>front/sitemap.jsp">网站地图</a></div>
        ...
        <div class="menu">
        	<div class="lxwm" style=" width:1000px;margin-top:10px;">
                <div class="fl lxwm_z">联系我们</div>
                <div class="fr">您现在的位置：<a href="<%=basePath%>index/homAct!home.action">首页</a> > <a href="<%=basePath%>contact/conAct!detail.action">联系我们</a></div>
                <div class="clear"></div>
            </div>
            <div class="lxwm_t"><div class="lxwm_wz">
            联系地址：${entity.address}<br/>
            邮政编码：${entity.postcode}<br/>
            联系人：${entity.linkman}<br/>
            联系电话：${entity.phone}<br/>
      Email：${entity.e_mail}<br/></div>
            </div>
        </div>
