...
<div class="headertop">
            ...
            <div style=" margin-top:10px;">
            	...
            	<div class="fr" style="width:744px;">
                	<div class="lxwm2" style=" width:744px; height:40px;">
                        ...
                        <div class="fr">您现在的位置：<a href="<%=basePath%>index/homAct!home.action">首页</a> > <a href="<%=basePath%>policy/epPolAct!list.action">环保政策法规</a></div>
                		<div class="clear"></div>
            		</div>
                    <div>
	...
	<span>　　　　　　　　　　　　　　　　　　　</span>
     <a href="<s:url value="/policy/epPolAct!list.action"><s:param name="method" value="%{'first'}"/><s:param name="pager.currentPage" value="pager.currentPage"/></s:url>"><span style="background:#DCD9D4;">首页</span></a>
     <a href="<s:url value="/policy/epPolAct!list.action"><s:param name="method" value="%{'back'}"/><s:param name="pager.currentPage" value="pager.currentPage"/></s:url>"><span style="background:#DCD9D4;">上一页</span></a>
     <span style="background:#EBEBEA;">&nbsp;<s:property value="pager.currentPage" />&nbsp;</span>
     <a href="<s:url value="/policy/epPolAct!list.action"><s:param name="method" value="%{'next'}"/><s:param name="pager.currentPage" value="pager.currentPage"/></s:url>"><span style="background:#DCD9D4;">下一页</span></a>
     <form action="<%=basePath%>policy/epPolAct!list.action" method="post" id="gotoform" style="margin-bottom: 0;float:right;">
...
<script type="text/javascript">
	function toPage() {
	 ...
	 <a href="<s:url value="/policy/epPolAct!list.action"><s:param name="method" value="%{'last'}"/><s:param name="pager.currentPage" value="pager.currentPage"/></s:url>"><span style="background:#DCD9D4;">尾页</span></a>
       </div>
                    </div>
                </div>
