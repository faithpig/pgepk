    ...
    <div style=" margin-top:10px;">
      ...
      <div class="fr" style="width:744px;">
        <div class="lxwm3" style=" width:744px; height:40px;">
          ...
          <div class="fr">您现在的位置：<a href="<%=basePath%>index/homAct!home.action">首页</a> > <a href="<%=basePath%>message/mesAct!list.action">留言板</a></div>
          <div class="clear"></div>
        </div>
        <div class="subCont">
                ...
                <table width="90%" border="0" align="center" cellpadding="0" cellspacing="0">
                  ...
                  <tr>
                    ...
                    <td><select name="columnName" id="column">
                    		<option value="基础知识" selected="selected">基础知识</option>
...
function cfm_msg(){
	...
	form.submit();
            ...
            <span>　　　　　　　　　　　　　</span>
     <a href="<s:url value="/message/mesAct!list.action"><s:param name="method" value="%{'first'}"/><s:param name="pager.currentPage" value="pager.currentPage"/></s:url>"><span style="background:#DCD9D4;">首页</span></a>
     <a href="<s:url value="/message/mesAct!list.action"><s:param name="method" value="%{'back'}"/><s:param name="pager.currentPage" value="pager.currentPage"/></s:url>"><span style="background:#DCD9D4;">上一页</span></a>
     <span style="background:#EBEBEA;">&nbsp;<s:property value="pager.currentPage" />&nbsp;</span>
     <a href="<s:url value="/message/mesAct!list.action"><s:param name="method" value="%{'next'}"/><s:param name="pager.currentPage" value="pager.currentPage"/></s:url>"><span style="background:#DCD9D4;">下一页</span></a>
     <form action="<%=basePath%>message/mesAct!list.action" method="post" id="gotoform" style="margin-bottom: 0;float:right;">
...
<script type="text/javascript">
	function toPage() {
	 ...
	 <a href="<s:url value="/message/mesAct!list.action"><s:param name="method" value="%{'last'}"/><s:param name="pager.currentPage" value="pager.currentPage"/></s:url>"><span style="background:#DCD9D4;">尾页</span></a>
          </div>
        </div>
      </div>
      <div class="clear"></div>
